...
namespace Beadle.Core.ViewModels
{
    public class MainViewModel : ViewModelBase
    {
        ...
        public MainViewModel(IRepository repository, INavigationService navigationService)
        {
            ...
            //initializers
            Task.Run(() => Init());
            //DateTime = new DateTime(2018,11,6,8,30,00);
            ...
            SearchPersonCommand = new Command(async () => await SearchProcAsync(), () => true);
        ...
        public async Task AddRandomSessionProcAsync()
        {
            ...
            session.Professor = FirstNameGenerator();
            session.SubjectCode = "DBTK 111";
            session.ClassCode = "141";
        ...
        public async Task ShowRecordInfoProcAsync()
        {
            ...
            if (RecordInfoViewModel != null)
            {
                    ...
                    RecordInfoViewModel.Days = new ObservableCollection<Day>();
                    RaisePropertyChanged(() => RecordInfoViewModel.Days);
                    RecordInfoViewModel.SelectedDay = null;
                    RaisePropertyChanged(() => RecordInfoViewModel.SelectedDay);
                    RaisePropertyChanged(() => RecordInfoViewModel);
            }
        ...
        public async Task SearchProcAsync()
        {
        ...
        public  async Task PersonListDisplayActionProcAsync()
        {
            ...
            switch (actionSheet)
            {
                case "Late":
                    ...
                    break;
                case "Absent":
                    await Task.Run(() => AddAbsenceProcAsync());
                    await Task.Run(() => RecordUpdater());
        ...
        {
            DateTime = DateTime.AddDays(7.01);
            RaisePropertyChanged(() => DateTime);
            var day = DateTime.DayOfWeek.ToString();
            DateTimeString = DateTime.ToString() + " - " + day;
            RaisePropertyChanged(() => DateTimeString);
